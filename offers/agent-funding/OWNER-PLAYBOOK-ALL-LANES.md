...
- Base/EVM USDC: 0x8928aFB2D1e2430338D7d4C9273F7A57e92a64de — USDC on Base ONLY (Kraken deposit, min 2.5); anything else sent there is lost.

Receive rails live without new ID (Jaron 2026-09-21): Chime, Uphold, Kraken, X Money, Robinhood, PayPal, Crypto.com. Stripe/Coinbase wait on replacement ID.

Files already on MSI:
- Drafts folder: C:\Users\lilli\Projects\watch\offers\agent-funding\
- P01 GOAT submitted: outreach\P01-GOAT-application-SUBMITTED-2026-09-21.md
- P03 Autonomys submitted: outreach\P03-AUTONOMYS-application-SUBMITTED-2026-09-21.md
- P10 Shieldz: outreach\P10-SHIELDZ-tip-page.md · TIP-JAR.md · SHIELDZ.json
- Master pitch: PITCH.md
- Ledger: PROSPECTS.md
- Wallets: WALLETS.json

Credit: Elons Twin draft, Claude Code fill, Jaron authorize/submit.
...
Status: **SUBMITTED / AWAITING-REPLY** (2026-09-21 via Tally tally.so/r/EkJo42). No confirmation id. No video required. Credit: Elons Twin draft, Claude Code fill, Jaron yes.

### A1. Make a short honest demo (2–4 min) — optional follow-up if they ask
...
### A2. Fill the GOAT form — DONE 2026-09-21

### A3. After submit — DONE
Artifact: outreach\P01-GOAT-application-SUBMITTED-2026-09-21.md. Ledger P01 = WAITING.
...
Status: **CLOSED until next round.** Guild 2.0 applications currently closed (logged 2026-09-21). Process when open: post project at hall.0g.ai (Guild on 0G 2.0 category), then 5-step form; KYC; $10K–$1M. Ledger P02 = CLOSED.

### C1–C3 — parked
Do not invent a form URL. Reopen when next round opens; P03 text adapts quickly.

---

## LANE D — Public tip jar (Shieldz / agent tips)
Status: **UNBLOCKED + LIVE.** Address confirmed; tip page stood up keyless (no wallet connect/sign).

### D1. Create a receive-only Base address — DONE
Address: 0x8928aFB2D1e2430338D7d4C9273F7A57e92a64de — USDC on Base ONLY (Kraken deposit, min 2.5); anything else sent there is lost. In WALLETS.json as usdc_base.

### D2. Stand up the tip jar — DONE 2026-09-21
Live URL: https://shieldz.cash/tip/tip-354e0ded9a592c31
Suggested: $3 / $5 / $10 / $25. Details: TIP-JAR.md · SHIELDZ.json · outreach/P10-SHIELDZ-tip-page.md
Next: optionally put tip URL on heartbeatobservatory.com and in PITCH.md.
